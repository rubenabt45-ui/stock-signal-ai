    ...
    try {
      ...
      if (error) {
        ...
        toast({
          ...
          description:
            "Please check your email and click the verification link. Don't forget to check your spam folder if you don't see it.",
          duration: 10000,
        });
      }
    } catch (error) {
      ...
      <div className="min-h-screen bg-tradeiq-navy flex items-center justify-center p-4">
        <Card className="tradeiq-card w-full max-w-md">
          <CardHeader className="text-center space-y-4">
            ...
            <CardDescription className="text-gray-400">{t("auth.login.subtitle")}</CardDescription>
          </CardHeader>
          <CardContent>
            {/* Status Alerts */}
            ...
            <form onSubmit={handleLogin} className="space-y-4 mt-6">
              ...
              <Button type="submit" disabled={loading} className="tradeiq-button-primary w-full">
            ...
            <div className="mt-4 text-center">
              <Link to="/reset-password-request" className="text-tradeiq-blue hover:text-blue-400 text-sm">
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-400 text-sm">
                ...
                <Link to="/signup" className="text-tradeiq-blue hover:text-blue-400 font-medium">
                  {t("auth.login.signUp")}
                </Link>
              </p>
            </div>
