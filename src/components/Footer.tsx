      ...
      <div className="container mx-auto">
        ...
        <div className="border-t border-border pt-6 text-center">
          <p className="text-xs text-muted-foreground">
            ...
            <a href="https://www.tradeiqpro.com" target="_blank" rel="noopener noreferrer" aria-label="Visit TradeIQ Pro website" className="text-primary hover:text-primary/80 hover:underline transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 rounded px-1 py-0.5">
              www.tradeiqpro.com
            </a>
          </p>
